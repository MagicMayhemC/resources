...
addEvent("SAdx.createNewDxMessage",true)
addEventHandler("SAdx.createNewDxMessage",localPlayer,createNewDxMessage)
...
addEvent("SAdx.createNewDxMessageBot",true)
addEventHandler("SAdx.createNewDxMessageBot",localPlayer,createNewDxMessageBot)
